...
const LeftMenu = ({ user, success}: Params) => {
   ...
   <>
    ...
    >
      ...
      >
          ...
          "
            >
              ...
              <div className="w-full h-1/2 flex flex-col justify-center items-center z-20 pt-2">
                <Link href='/login'>
                  <h1 className="text-gray-700 font-bold cursor-pointer  underline">Iniciar Sesión</h1>
                </Link>
              </div>
        ...
        {/* SECOND COL */}
        <div className="w-full xs:h-[250px] xp:h-full sm:h-full flex flex-col pt-10 sm:pt-5 ">
            <div className="w-full h-5/6 flex justify-center items-center">
                <div className={`w-[150px] ${success ? 'h-[350px]' : 'h-[280px]'}  grid grid-col-1 `}>
                  {
                    success ? menuItemsOn.map((items: MenuItems) => (
            ...
            <div className="w-full h-1/6  flex justify-center items-center">
                <p className={`text-[14px] text-blue-500 ${ success ? 'block' : 'hidden'} cursor-pointer `} onClick={handleLogOut}>Cerrar sesión</p>
            </div>
        </div>
